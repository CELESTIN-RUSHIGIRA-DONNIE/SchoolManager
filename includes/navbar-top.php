<nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary shadow">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.html">Donnie HightSchool</a>
    <!-- Sidebar Toggle-->
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">clic to "Oui" or "Non"</div>
            <div class="modal-footer">
                <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Non</button>
                <form action="logout.php" method="POST">
                    <button type="submit" name="logout_btn" class="btn btn-primary btn-sm">Oui</button>
                </form>
            </div>
        </div>
    </div>
